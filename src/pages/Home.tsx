...
//   return (
//      <div className="min-h-screen font-sans bg-[#DDF4E7]">
//       <AlertPopup />
...
//               {/* <Link
//                 to="/booking"
//                 className="bg-[#8FC0A9] hover:bg-[#7AB095] text-[#2D4A3E] text-lg px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center"
//               >
//                 Book Now
//                 <ArrowRight className="ml-2 w-5 h-5" />
//               </Link> */}
...
//       {/* Rest of your sections remain exactly the same */}
//       {/* Promo Banner */}
//       <div className="bg-gradient-to-r from-[#8FC0A9] to-[#68A089] py-3 overflow-hidden text-[#2D4A3E]">
//         <div className="animate-marquee whitespace-nowrap">
//           <span className="text-lg font-medium mx-8">✨ 20% off for 10+ day stays</span>
//           <span className="text-lg font-medium mx-8">🌿 10% off for 5+ day stays</span>
//           {/* <span className="text-lg font-medium mx-8">🌸 Special rates for June & July</span> */}
...
//       {/* Key Highlights Section */}
//       <section className="py-20 px-4 bg-[#DDF4E7]">
//         <div className="max-w-7xl mx-auto">
//           <motion.div 
//             initial={{ opacity: 0, y: 30 }}
//             whileInView={{ opacity: 1, y: 0 }}
...
//             className="text-center mb-16"
//           >
//             <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#2D4A3E] mb-4">
//               Experience Nowal NatureCare
//             </h2>
//             <div className="flex justify-center items-center">
//               <div className="w-16 h-1 bg-[#8FC0A9] mr-3"></div>
//               <Leaf className="text-[#68A089] w-6 h-6" />
//               <div className="w-16 h-1 bg-[#8FC0A9] ml-3"></div>
//             </div>
//           </motion.div>
...
//                 viewport={{ once: true }}
//                 whileHover={{ y: -10, scale: 1.02 }}
//                 className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#C8E6D5] group"
//               >
//                 <div className="w-14 h-14 bg-[#DDF4E7] rounded-full flex items-center justify-center mb-6 group-hover:bg-[#68A089] transition-all">
//                   <highlight.icon className="w-6 h-6 text-[#68A089] group-hover:text-white transition-all" />
//                 </div>
//                 <h3 className="text-xl font-semibold text-[#2D4A3E] mb-3">{highlight.title}</h3>
//                 <p className="text-[#4A6B5F]">{highlight.description}</p>
//               </motion.div>
//             ))}
//           </div>
//         </div>
...
//       {/* Accreditation Banner */}
//       <section className="py-12 px-4 bg-gradient-to-b from-[#DDF4E7] to-[#C8E6D5]">
//   <div className="flex justify-center">
//     <motion.div 
//       initial={{ opacity: 0, y: 30 }}
//       whileInView={{ opacity: 1, y: 0 }}
...
//     >
//       <div className="flex flex-col md:flex-row items-center justify-center p-8">
//         <div className="w-40 h-40 bg-[#DDF4E7] rounded-full flex items-center justify-center border-4 border-[#C8E6D5] shadow-inner shrink-0">
//           <Award className="w-16 h-16 text-[#68A089]" />
//         </div>
        
//         <div className="md:ml-8 mt-6 md:mt-0 text-center">
//           <div className="relative inline-block">
//             <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#2D4A3E] mb-2">
//               Welcome to Nowal NatureCare
//             </h2>
//             <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-[#8FC0A9] to-[#68A089]"></div>
//           </div>
//         </div>
//       </div>
//     </motion.div>
...
//       {/* Treatments Section */}
//       <section className="py-20 px-4 bg-gradient-to-b from-[#C8E6D5] to-[#DDF4E7]">
//   <div className="max-w-6xl mx-auto text-center">
//     <motion.div
//       initial={{ opacity: 0, y: 30 }}
//       whileInView={{ opacity: 1, y: 0 }}
...
//       className="mb-16"
//     >
//       <h1 className="text-3xl md:text-4xl font-serif font-bold text-[#2D4A3E] mb-4">
//         Experience the power of nature in every healing touch
//       </h1>
//       <h5 className="text-2xl font-medium text-[#3E5F51]">Healing Program</h5>
//             <div className="flex justify-center items-center">
//               <div className="w-16 h-1 bg-[#8FC0A9] mr-3"></div>
//               <Leaf className="text-[#68A089] w-6 h-6" />
//               <div className="w-16 h-1 bg-[#8FC0A9] ml-3"></div>
...
//     <p className="text-[#4A6B5F] max-w-2xl mx-auto text-lg mb-12">
//       Nowal NatureCare guides you on a journey back to balance, awakening the natural healer that already lives inside you
//     </p>

//     <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
//   {[
//     { image: naturopathy, title: "Naturopathy", color: "text-[#68A089]", bg: "bg-[#E8F5EF]" },
//     { image: ayurveda, title: "Ayurveda", color: "text-[#A68A56]", bg: "bg-[#F5F0E8]" },
//     { image: meditationYoga, title: "Yoga and Meditation  ", color: "text-[#7D68A0]", bg: "bg-[#EFE8F5]" },
//     { image: physiotherapy, title: "Physiotherapy", color: "text-[#688CA0]", bg: "bg-[#E8EFF5]" },
//     { image: treatments, title: "Acupuncture", color: "text-[#A0687D]", bg: "bg-[#F5E8EF]" },
//   ].map((item, index) => (
//     <motion.div
//       key={index}
//       initial={{ opacity: 0, y: 30 }}
...
//         <img src={item.image} alt={item.title} className="w-10 h-10 mx-auto object-contain" />
//       </div>
//       <h3 className="font-semibold text-[#2D4A3E]">{item.title}</h3>
//     </motion.div>
//   ))}
// </div>
...
//       {/* Diseases Treated Section */}
//       <section className="relative py-20 px-4 text-[#2D4A3E] overflow-hidden">
//         <div className="absolute inset-0">
//           <img 
//             src="https://images.unsplash.com/photo-1505751172876-fa1923c5c528?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" 
//             alt="Background" 
//             className="w-full h-full object-cover"
//           />
//           <div className="absolute inset-0 bg-[#68A089]/90 backdrop-blur-sm"></div>
//         </div>
...
//               Diseases Treated
//             </h2>
//             <p className="text-[#E8F5EF] max-w-3xl mx-auto text-lg">
//            	Nowal NatureCare believes in healing from within—through detox and natural therapies that support your body's full well-being
//             </p>
//           </motion.div>
...
//                 viewport={{ once: true }}
//                 whileHover={{ scale: 1.03 }}
//                 className="flex items-center gap-4 bg-white/20 backdrop-blur-sm border border-white/30 px-6 py-5 rounded-xl shadow-md transition-all"
//               >
//                 <div className="bg-white p-2 rounded-lg shadow-sm">
//                   <item.icon className="w-6 h-6 text-[#68A089]" />
//                 </div>
//                 <h3 className="font-semibold text-lg">{item.title}</h3>
//               </motion.div>
//             ))}
...
//       {/* Therapies Section */}
//     <section className="py-20 px-4 bg-gradient-to-b from-[#DDF4E7] to-[#C8E6D5]">
//   <div className="max-w-7xl mx-auto text-center">
//     <motion.div
//       initial={{ opacity: 0, y: 30 }}
//       whileInView={{ opacity: 1, y: 0 }}
...
//       className="mb-16"
//     >
//       <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#2D4A3E] mb-2">
//         Popular Therapies
//       </h2>
//       <div className="flex justify-center items-center">
//         <div className="w-16 h-1 bg-[#8FC0A9] mr-3"></div>
//         <HeartPulse className="text-[#68A089] w-6 h-6" />
//         <div className="w-16 h-1 bg-[#8FC0A9] ml-3"></div>
//       </div>
//     </motion.div>
...
//       <div className="flex justify-center items-center">
//         <div className="w-16 h-1 bg-[#8FC0A9] mr-3"></div>
//         <Star className="text-[#E8F5EF] w-5 h-5" />
//         <div className="w-16 h-1 bg-[#8FC0A9] ml-3"></div>
//       </div>
//     </motion.div>
...
//           viewport={{ once: true }}
//           whileHover={{ scale: 1.02 }}
//           className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl p-8 text-center transition-all"
//         >
//           <motion.div whileHover={{ scale: 1.05 }} className="flex justify-center">
//             <div className="rounded-full w-32 h-32 flex items-center justify-center bg-[#E8F5EF] border-4 border-[#C8E6D5] shadow-md">
//               <svg 
//                 className="w-20 h-20 text-[#68A089]" 
//                 fill="currentColor" 
//                 viewBox="0 0 20 20" 
//                 xmlns="http://www.w3.org/2000/svg"
//               >
...
//           </motion.div>
//           <div className="mt-6 relative">
//             <FaQuoteLeft className="inline mr-2 text-[#E8F5EF] text-xl" />
//             <p className="inline leading-relaxed text-[#F5FBFA]">{t.quote}</p>
//             <FaQuoteRight className="inline ml-2 text-[#E8F5EF] text-xl" />
//           </div>
//           <div className="mt-6 flex flex-col items-center">
//             <span className="font-semibold text-lg">{t.name}</span>
//           </div>
...
//       <div className="flex justify-center items-center">
//         <div className="w-16 h-1 bg-[#8FC0A9] mr-3"></div>
//         <BadgePlus className="text-[#68A089] w-6 h-6" />
//         <div className="w-16 h-1 bg-[#8FC0A9] ml-3"></div>
//       </div>
//     </motion.div>
...
//               <Link
//                 to="/booking"
//                 className="bg-[#68A089] hover:bg-[#5A8D7A] text-white text-lg px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center"
//               >
//                 Book Now
//                 <ArrowRight className="ml-2 w-5 h-5" />
//               </Link>
//               <Link
//                 to="/treatments"
//                 className="border-2 border-white hover:bg-white/20 text-white text-lg px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center"
//               >
//                 Explore Treatments
//               </Link>
//             </div>
...
//       {/* Promo Banner */}
//       <div className="bg-gradient-to-r from-[#68A089] to-[#5A8D7A] py-3 overflow-hidden text-white">
//         <div className="animate-marquee whitespace-nowrap">
//           <span className="text-lg font-medium mx-8">✨ 20% off for 10+ day stays</span>
//           <span className="text-lg font-medium mx-8">🌿 10% off for 5+ day stays</span>
//           <span className="text-lg font-medium mx-8">💚 Free nowal consultation</span>
...
//             </h2>
//             <div className="flex justify-center items-center">
//               <div className="w-16 h-1 bg-[#68A089] mr-3"></div>
//               <Leaf className="text-[#5A8D7A] w-6 h-6" />
//               <div className="w-16 h-1 bg-[#68A089] ml-3"></div>
//             </div>
//           </motion.div>
...
//                 className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#C8E6D5] group"
//               >
//                 <div className="w-14 h-14 bg-[#E8F5EF] rounded-full flex items-center justify-center mb-6 group-hover:bg-[#68A089] transition-all">
//                   <highlight.icon className="w-6 h-6 text-[#68A089] group-hover:text-white transition-all" />
//                 </div>
//                 <h3 className="text-xl font-semibold text-[#2D4A3E] mb-3">{highlight.title}</h3>
//                 <p className="text-[#4A6B5F]">{highlight.description}</p>
...
//       {/* Accreditation Banner */}
//       <section className="py-12 px-4 bg-gradient-to-b from-[#E8F5EF] to-[#DDF4E7]">
//         <div className="flex justify-center">
//           <motion.div 
//             initial={{ opacity: 0, y: 30 }}
//             whileInView={{ opacity: 1, y: 0 }}
...
//           >
//             <div className="flex flex-col md:flex-row items-center justify-center p-8">
//               <div className="w-40 h-40 bg-[#E8F5EF] rounded-full flex items-center justify-center border-4 border-[#C8E6D5] shadow-inner shrink-0">
//                 <Award className="w-16 h-16 text-[#68A089]" />
//               </div>
...
//                     Welcome to Nowal NatureCare
//                   </h2>
//                   <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-[#68A089] to-[#5A8D7A]"></div>
//                 </div>
//                 <p className="text-[#4A6B5F] mt-4 max-w-xl">
//                   A premier wellness destination where ancient healing traditions meet modern comfort, 
//                   offering transformative experiences for body, mind and spirit.
//                 </p>
//               </div>
//             </div>
//           </motion.div>
...
//       {/* Treatments Section */}
//       <section className="py-20 px-4 bg-gradient-to-b from-[#E8F5EF] to-[#DDF4E7]">
//         <div className="max-w-6xl mx-auto text-center">
//           <motion.div
//             initial={{ opacity: 0, y: 30 }}
//             whileInView={{ opacity: 1, y: 0 }}
...
//             <div className="flex justify-center items-center">
//               <div className="w-16 h-1 bg-[#68A089] mr-3"></div>
//               <HeartPulse className="text-[#5A8D7A] w-6 h-6" />
//               <div className="w-16 h-1 bg-[#68A089] ml-3"></div>
//             </div>
//           </motion.div>
...
//                   <span className="text-[#E8F5EF]">{t.role}</span>
//                 </div>
//               </motion.div>
//             ))}
//           </div>
...
//             <div className="flex justify-center items-center">
//               <div className="w-16 h-1 bg-[#68A089] mr-3"></div>
//               <BadgePlus className="text-[#5A8D7A] w-6 h-6" />
//               <div className="w-16 h-1 bg-[#68A089] ml-3"></div>
//             </div>
//           </motion.div>
...
//                   <p className="text-[#4A6B5F] mb-4">
//                     Discover the latest in natural healing and wellness practices from our experts.
//                   </p>
//                   <Link 
//                     to="/blog" 
//                     className="inline-flex items-center text-[#68A089] hover:text-[#5A8D7A] font-medium transition-colors"
//                   >
//                     Read more
//                     <ArrowRight className="ml-1 w-4 h-4" />
//                   </Link>
...
//       {/* CTA Section */}
//       <section className="py-16 px-4 bg-gradient-to-r from-[#68A089] to-[#5A8D7A] text-white">
...
//               Experience the transformative power of nature at Nowal NatureCare
//             </p>
//             <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
//               <Link
//                 to="/booking"
//                 className="bg-white text-[#2D4A3E] hover:bg-[#E8F5EF] text-lg px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center"
//               >
//                 Book Your Stay
//                 <ArrowRight className="ml-2 w-5 h-5" />
//               </Link>
...
>
  <source src={heroVideos[currentVideoIndex].video} type="video/mp4" />
      ...
      {/* Promo Banner */}
      <div className="bg-gradient-to-r from-[#2D4A3E] to-[#3E5F51] py-3 overflow-hidden text-white">
        <div className="animate-marquee whitespace-nowrap">
          <span className="text-lg font-medium mx-8">✨ 20% off for 10+ day stays</span>
          <span className="text-lg font-medium mx-8">🌿 10% off for 5+ day stays</span>
          <span className="text-lg font-medium mx-8">💚 Free nowal consultation</span>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-[#2D4A3E] to-[#3E5F51] text-white">
        <div className="max-w-5xl mx-auto text-center">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
