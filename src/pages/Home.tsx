...
// import { Leaf, FlaskConical, CircleDashed } from 'lucide-react';
...
//   // Updated to use local video assets
//   const heroVideos = [
//     {
//       video: video1,
//       title: heroMessages[0],
...
//   <div className="absolute inset-0">
//     <img 
//       src="https://i.pinimg.com/736x/2a/86/2b/2a862b817d44bdde4296f8590cc3af28.jpg" 
//       alt="Background" 
//       className="w-full h-full object-cover"
//     />
//     {/* Add a darker overlay for better text contrast */}
//     <div className="absolute inset-0 bg-[#2A4E38]/80 backdrop-blur-sm"></div>
//   </div>
...
//         Diseases Treated
//       </h2>
//       <p className="text-[#e8f0ea] max-w-3xl mx-auto text-lg">
//         Nowal NatureCare believes in healing from within—through detox and natural therapies that support your body's full well-being
//       </p>
//     </motion.div>
...
//           viewport={{ once: true }}
//           whileHover={{ scale: 1.03 }}
//           className="flex items-center gap-4 bg-white/20 backdrop-blur-md border border-white/30 px-6 py-5 rounded-xl shadow-lg transition-all"
//         >
//           <div className="bg-white p-2 rounded-lg shadow-sm">
//             <item.icon className="w-6 h-6 text-[#2A4E38]" />
//           </div>
...
//   // Updated to use video URLs from admin panel (you can replace these with dynamic data)
//   const heroVideos = [
//     {
//       video: "/assets/medi_large.mp4", // This will be dynamically set from admin panel
//       title: heroMessages[0],
//       subtitle: "Science-backed ancient healing. Your journey to wholeness starts here."
//     },
//     {
//       video: "/assets/birdvideo.mp4", // This will be dynamically set from admin panel
//       title: heroMessages[1],
//       subtitle: "Connect with nature and rediscover your balance."
//     },
//     {
//       video: "/assets/meditationvideo.mp4", // This will be dynamically set from admin panel
//       title: heroMessages[2],
//       subtitle: "Premium Nowal treatments in a serene environment."
//     }
//   ];
...
const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <meta name="google-site-verification" content="IrfNHLtCiHMepVodpL5ddC06jHe2Cac4E_Uw3taI64Q" />
      </Helmet>
