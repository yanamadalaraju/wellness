    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <img
            src="https://media.istockphoto.com/id/1135761958/photo/physiotherapist-massaging-young-woman.jpg?s=612x612&w=0&k=20&c=SfCYKix5c2uyvOqf1W64lR9LbzlShBfgaUOl9F6kx70="
