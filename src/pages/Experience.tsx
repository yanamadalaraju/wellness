      ...
      <div className="container mx-auto px-4 py-6">
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-2 md:space-x-3">
            <li className="inline-flex items-center">
              <Link to="/" className="text-[#2C3E50] hover:text-[#34495E] text-sm md:text-base flex items-center">
            ...
            <li className="flex items-center">
              <svg className="w-3 h-3 text-[#BDC3C7] mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 9 4-4-4-4"/>
              </svg>
            </li>
            <li aria-current="page">
              <span className="text-[#34495E] font-medium text-sm md:text-base">The Mantra</span>
            </li>
          </ol>
        </nav>
      </div>
