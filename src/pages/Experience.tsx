...
const Experience: React.FC = () => {
  ...
  <div className="max-w-5xl mx-auto">
    ...
    <p className="text-base md:text-lg leading-relaxed">
      At Nimba, our philosophy is simple yet profound: <span className="font-semibold">health and healing always come first.</span> 
  ...
  <div className="absolute left-1/2 bottom-[-180px] transform -translate-x-1/2 w-full max-w-5xl bg-[#F2F1E8] text-center px-6 py-14 shadow-2xl rounded-xl">
    ...
    <p className="text-lg md:text-xl leading-relaxed mb-4">
      Here, at Nimba, we take your hand and walk you through the truth of life — that <span className="font-semibold">health is under our control, always.</span>
    </p>
    <p className="text-lg md:text-xl leading-relaxed mb-4">
