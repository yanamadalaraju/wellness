    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <img
            src="https://media.istockphoto.com/id/1483989816/photo/adult-arab-male-with-a-ponytail-meditating-in-a-yoga-class.jpg?s=612x612&w=0&k=20&c=FTkO8dit_ZWB_9mUk2bmkELm2mpC-NqH82nCmK1Wx6M="
       ...
       {/* Breadcrumbs */}
                <div className="container mx-auto px-4 py-4 flex justify-center">
                    ...
                    <ol className="inline-flex items-center space-x-2 md:space-x-2">
                        ...
                        <li>
                        <span className="text-sage-800 font-medium">Recreation Spaces</span>
                        </li>
                    </ol>
                    </nav>
                </div>
