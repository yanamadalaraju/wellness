    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <img
            src="https://media.istockphoto.com/id/2195632746/photo/asian-man-sporting-calf-cramping.jpg?s=612x612&w=0&k=20&c=UfOt23n9mf_Fe5IN8_hbNq_Ot_46l0FHky5PaZLCuLk="
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          HealingAbode Meditation Sessions
          </h1>
      ...
      {/* Breadcrumbs */}
          <div className="container mx-auto px-4 py-4 flex justify-center">
              ...
              <ol className="inline-flex items-center space-x-2 md:space-x-2">
                  ...
                  <li>
                  <span className="text-sage-800 font-medium">Healing Abode</span>
                  </li>
              </ol>
              </nav>
          </div>
