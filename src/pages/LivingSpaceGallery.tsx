...
import ImagegridLiving from '../components/ImagegridLiving';
import image from "../assets/3d1.jpg"

const LivingSpaceWellness: React.FC = () => {
...
export default LivingSpaceWellness;