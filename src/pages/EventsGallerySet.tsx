...
import ImagegridEvent from '../components/ImagegridEvent';
import image from "../assets/3d2-1.jpg"

const EventsGallerySet: React.FC = () => {
      ...
      {/* Breadcrumbs */}
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-2 md:space-x-2">
            ...
            <li>
              <span className="text-sage-800 font-medium">Event Gallery</span>
            </li>
          </ol>
        </nav>
      </div>
...
export default EventsGallerySet;