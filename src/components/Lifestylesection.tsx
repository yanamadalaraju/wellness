...
import React, { useState } from 'react';
import { FaBone, FaRunning, FaHeadSideCough, FaWalking, FaCheckCircle } from 'react-icons/fa';
...
const therapies = [
  {
    name: 'Osteoarthritis',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/MUSCULOSKELETAL-CONDITIONS_OSTEOARTHRITIS.png',
    content: 'Colon hydrotherapy is a gentle infusion of water into the colon to remove waste. It helps relieve constipation, improve digestion, and promote detoxification. This technique is used as a natural detox process and is highly effective for people suffering from chronic constipation, gas, and bloating.',
    benefits: ['Improves digestion', 'Removes toxins', 'Boosts hydration'],
    icon: <FaBone className="text-sage-400" />
  },
  {
    name: 'Rheumatoid Arthritis',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/MUSCULOSKELETAL-CONDITIONS_RHEUMATOID_ARTHRITIS.png',
    content: 'Manipulative therapy involves manual techniques to alleviate musculoskeletal pain and improve mobility. It is commonly used in physiotherapy and chiropractic treatment. This therapy also helps restore joint function and reduce inflammation through controlled movements and pressure.',
    benefits: ['Relieves pain', 'Improves mobility', 'Reduces stress'],
    icon: <FaRunning className="text-sage-500" />
  },
  {
    name: 'Cervical Spondylitis',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/MUSCULOSKELETAL-CONDITIONS_CERVICAL_SPONDYLOSIS.png',
    content: 'Enema is used to clean the colon by injecting fluid into the rectum. It promotes bowel movements and treats constipation effectively. This therapy is a natural way to remove toxins and reset your digestive health, especially helpful during fasting or detoxification routines.',
    benefits: [
      'Removes stagnant fecal matter',
      'Treats constipation',
      'Boosts the absorption of nutrients',
    ...
    icon: <FaHeadSideCough className="text-sage-600" />
  },
  {
    name: 'Sciatica',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/MUSCULOSKELETAL-CONDITIONS_SCIATICA.png',
    content: 'Mud pack therapy uses natural mud applied to the body or specific areas to reduce inflammation, improve skin health, and relax the body. It is especially useful in managing acne, arthritis, and general fatigue through cooling and mineral absorption.',
    benefits: ['Relieves pain', 'Improves skin texture', 'Cools the body'],
    icon: <FaWalking className="text-sage-300" />
  }
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Natural therapies for improved wellbeing and quality of life
          </p>
        </div>
