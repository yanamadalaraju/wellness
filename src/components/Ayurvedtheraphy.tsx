...
//   {
//     name: 'Potli Massage',
//     image: 'https://www.nimba.in/wp-content/uploads/2021/02/POTLIMASSAGE.jpg',
//     content:
...
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/ABHAYANGAM.jpg',
//     content:
...
//   {
//     name: 'Udhvartan',
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/UDHAVARTAN.jpg',
//     content:
...
//   {
//     name: 'Shirodhara',
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/SHIRODHARA.jpg',
//     content:
...
//   {
//     name: 'Panchakarma',
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/PNACHAKARMA.jpg',
//     content:
...
// export default AyurvedsTherapySection;
...
const therapies = [
  {
    name: 'Potli Massage',
    image: 'https://www.nimba.in/wp-content/uploads/2021/02/POTLIMASSAGE.jpg',
    content: 'A traditional Ayurvedic massage using herbal pouches to relieve muscle tension, improve circulation, and detoxify the body through the therapeutic properties of medicinal herbs.',
    benefits: [
      'Relieves muscle stiffness',
      'Improves blood circulation',
      'Detoxifies through herbal infusion',
  ...
  },
  {
    name: 'Abhyangam Therapy',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/ABHAYANGAM.jpg',
    content: 'A synchronized full-body massage with warm herbal oils that nourishes tissues, eliminates toxins, and promotes deep relaxation while balancing the doshas (body energies).',
    benefits: [
  ...
  },
  {
    name: 'Udhvartan',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/UDHAVARTAN.jpg',
    content: 'A unique herbal powder massage that helps in weight management, improves skin texture, and stimulates the lymphatic system for effective toxin removal.',
    benefits: [
      'Aids in weight reduction',
      'Exfoliates and revitalizes skin',
      'Improves metabolism',
      'Reduces cellulite'
    ],
  },
  {
    name: 'Shirodhara',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/SHIRODHARA.jpg',
    content: 'A profoundly relaxing therapy where warm herbal oil is poured in a continuous stream on the forehead, calming the mind and nervous system while promoting mental clarity.',
    benefits: [
  ...
  },
  {
    name: 'Panchakarma',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/PNACHAKARMA.jpg',
    content: 'The ultimate Ayurvedic detoxification program combining five therapeutic actions to eliminate deep-rooted toxins and restore the body\'s natural balance.',
    benefits: [
...
const AyurvedsTherapySection = () => {
  const [selected, setSelected] = useState(therapies[2]); // Default: Udhvartan
  const [isHovering, setIsHovering] = useState(false);

  return (
    <section className="relative bg-gradient-to-br from-[#f3f4ee] to-[#e8eae0] py-16 md:py-24 px-4 md:px-8 overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex justify-center mb-8 md:mb-12">
          <div className="inline-flex flex-wrap justify-center gap-2 bg-white p-2 rounded-full shadow-lg border border-gray-100 max-w-full">
            {therapies.map((therapy) => (
              <button
                key={therapy.name}
                onClick={() => setSelected(therapy)}
                className={`relative px-4 py-2 md:px-5 md:py-2.5 rounded-full text-xs md:text-sm font-medium transition-all duration-300 ${
                  selected.name === therapy.name
            ...
            >
              <div className="relative w-full max-w-4xl h-56 md:h-72 rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute bottom-0 left-0 p-4 md:p-6 text-white">
                  ...
                  <p className="text-sage-100 text-sm md:text-base">Ayurvedic Treatment</p>
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-10">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                    <FaCheck className="text-sage-500" />
                    Key Benefits
                  </h4>
