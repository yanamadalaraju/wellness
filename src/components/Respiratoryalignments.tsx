...
//     ],
//     icon: <FaLungs className="text-blue-400" />
//   },
//   {
//     name: 'Sinusitis',
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/RESPIRATORY_AILMENTS_PULMONARY_SINUSITIS.png',
...
//     ],
//     icon: <FaHeadSideCough className="text-purple-400" />
//   },
//   {
//     name: 'Allergic Bronchitis',
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/RESPIRATORY_AILMENTS_PULMONARY_ALLERGIC_BRONCHITIS.png',
...
//       'Minimizes allergic triggers'
//     ],
//     icon: <FaAllergies className="text-green-400" />
//   },
//   {
//     name: 'Asthma',
//     image: 'https://www.nimba.in/wp-content/uploads/2020/07/RESPIRATORY_AILMENTS_ASTHAMA.png',
...
//       'Improves bronchial dilation',
//       'Decreases medication dependency',
//       'Enhances exercise tolerance'
//     ],
//     icon: <FaWind className="text-teal-400" />
//   }
// ];
...
//   return (
//     <section className="relative bg-gradient-to-br from-[#f0f7f4] to-[#e4efe9] py-16 md:py-24 px-4 md:px-8 overflow-hidden">
//       {/* Decorative elements */}
//       <div className="absolute inset-0 pointer-events-none">
//         <div className="absolute top-20 left-10 w-40 h-40 rounded-full bg-blue-100/20 blur-3xl"></div>
//         <div className="absolute bottom-1/4 right-20 w-60 h-60 rounded-full bg-teal-100/20 blur-3xl"></div>
//       </div>

//       <div className="max-w-7xl mx-auto relative z-10">
//         {/* Section header */}
//         <div className="text-center mb-12">
//           <span className="inline-block mb-3 text-sm uppercase tracking-widest text-teal-600 font-semibold">
//             Respiratory Care
//           </span>
//           <h2 className="text-3xl md:text-4xl font-bold font-playfair text-gray-900 mb-3">
//             <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-400">Respiratory Ailments</span> Treatment
//           </h2>
//           <p className="text-gray-600 max-w-2xl mx-auto">
//             Natural therapies for breathing disorders and chronic respiratory conditions
//           </p>
//         </div>
...
//                       className="flex items-start gap-3 bg-teal-50/50 px-4 py-3 rounded-lg text-gray-800 border border-teal-100 hover:border-teal-200 transition-colors text-sm"
//                     >
...
//               <button className="px-5 py-2.5 bg-gradient-to-r from-teal-500 to-blue-500 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all flex items-center gap-2 text-sm">
...
const therapies = [
  {
    ...
    icon: <FaLungs className="text-sage-400" />
  },
  {
    name: 'Sinusitis',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/RESPIRATORY_AILMENTS_PULMONARY_SINUSITIS.png',
    ...
    icon: <FaHeadSideCough className="text-sage-500" />
  },
  {
    name: 'Allergic Bronchitis',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/RESPIRATORY_AILMENTS_PULMONARY_ALLERGIC_BRONCHITIS.png',
    ...
    icon: <FaAllergies className="text-sage-600" />
  },
  {
    name: 'Asthma',
    image: 'https://www.nimba.in/wp-content/uploads/2020/07/RESPIRATORY_AILMENTS_ASTHAMA.png',
    ...
    icon: <FaWind className="text-sage-300" />
  }
];
...
const RespiratoryAilments = () => {
    ...
    <section className="relative bg-gradient-to-br from-[#f8f9f5] to-[#eef0e8] py-16 md:py-24 px-4 md:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-playfair text-gray-900 mb-3">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-600 to-sage-400">Respiratory Ailments</span> Treatment
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Holistic therapies for improved breathing and respiratory health
          </p>
        </div>
  ...
  <div className="inline-flex rounded-full bg-white p-1 shadow-lg border border-gray-100">
    {therapies.map((therapy) => (
      ...
      >
        {/* Modified icon with dynamic color */}
        {React.cloneElement(therapy.icon, {
          className: `${
            selected.name === therapy.name
              ? 'text-white'  // White when selected
              : therapy.icon.props.className  // Keep original sage color when not selected
          }`
        })}
        {therapy.name}
      </button>
