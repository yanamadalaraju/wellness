...
// Sample image URLs for nature/wellness theme
const imageUrls = [
  'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=1920', // Yoga
  'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920', // Mountains
  'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=1920', // Sunrise
  'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=1920', // Meditation
  'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=1920', // Forest
  'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920', // Nature
  'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1920', // Wellness
  'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=1920', // Yoga
  'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=1920', // Sunrise
  'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=1920'  // Forest
];
...
const DinHeroSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setCurrentSeason(month >= 11 || month <= 2 ? 'winter' : 'summer');
  }, []);

  const winterSchedule = [
    { time: "6:30 AM", activity: "Wake Up (Morning Raaga)" },
    { time: "6:45 AM – 7:30 AM", activity: "Yoga Kriyas" },
    { time: "7:30 AM", activity: "Herbal Hot Drink" },
    { time: "7:45 AM – 8:30 AM", activity: "Pranayama & General Yoga" },
    { time: "8:30 AM – 8:45 AM", activity: "Reflexology Walk" },
    { time: "8:45 AM", activity: "Fresh Juice" },
    { time: "9:00 AM – 11:00 AM", activity: "Naturopathy Treatments" },
    { time: "11:30 AM – 1:00 PM", activity: "Lunch" },
    { time: "1:00 PM – 2:00 PM", activity: "Rest" },
    { time: "2:00 PM", activity: "Juice" },
    { time: "2:00 PM – 3:00 PM", activity: "Naturopathy Treatments" },
    { time: "3:30 PM – 4:00 PM", activity: "Spinal / Weight-Loss Yoga (Alternate Days)" },
    { time: "4:00 PM", activity: "Juice" },
    { time: "4:00 PM – 5:30 PM", activity: "Therapy Time" },
    { time: "5:30 PM – 6:15 PM", activity: "General Yoga" },
    { time: "6:30 PM – 7:30 PM", activity: "Dinner" },
    { time: "8:00 PM", activity: "Night Drink" },
    { time: "8:10 PM – 8:25 PM", activity: "Self-Realisation & Gratitude Time" },
    { time: "8:25 PM – 8:40 PM", activity: "Family / Connection Time" },
    { time: "8:45 PM – 9:00 PM", activity: "Yoga Nidra" },
    { time: "9:00 PM onwards", activity: "Bedtime" }
  ];

  const summerSchedule = [
    { time: "4:45 AM", activity: "Morning Walk" },
    { time: "5:30 AM – 6:15 AM", activity: "Yoga Kriyas" },
    { time: "6:15 AM", activity: "Herbal Drink" },
    { time: "6:30 AM – 7:15 AM", activity: "Pranayama & General Yoga" },
    { time: "7:30 AM – 7:45 AM", activity: "Reflexology Walk" },
    { time: "7:45 AM", activity: "Fresh Juice" },
    { time: "8:00 AM – 10:00 AM", activity: "Naturopathy Treatments" },
    { time: "11:30 AM – 1:00 PM", activity: "Lunch" },
    { time: "1:00 PM – 2:00 PM", activity: "Rest" },
    { time: "2:00 PM", activity: "Juice" },
    { time: "2:00 PM – 3:00 PM", activity: "Naturopathy Treatments" },
    { time: "3:30 PM – 4:00 PM", activity: "Spinal / Weight Management Yoga (Alternate Days)" },
    { time: "4:00 PM", activity: "Juice" },
    { time: "4:00 PM – 5:30 PM", activity: "Therapy Time" },
    { time: "5:30 PM – 6:15 PM", activity: "General Yoga" },
    { time: "6:30 PM – 7:30 PM", activity: "Dinner" },
    { time: "8:00 PM", activity: "Night Drink" },
    { time: "8:10 PM – 8:25 PM", activity: "Self-Realisation Time" },
    { time: "8:25 PM – 8:40 PM", activity: "Family / Quiet Time" },
    { time: "8:45 PM – 9:00 PM", activity: "Yoga Nidra" },
    { time: "9:00 PM onwards", activity: "Bedtime" }
  ];

  const currentSchedule = currentSeason === 'winter' ? winterSchedule : summerSchedule;
  
  // Get the current highlighted time slot based on activeIndex
  const highlightedSlotIndex = activeIndex % currentSchedule.length;
    ...
    >
      ...
      <ContentWrapper>
        <TextContent>
          ...
          <Subtitle>
            Embrace the ancient wisdom of daily routine for optimal health and wellness. 
            Align your day with nature's rhythms at Nowal Naturecare.
          </Subtitle>
        </TextContent>
        ...
        <TimingContent>
          ...
          <ScheduleTitle>
            Nowal Naturecare {currentSeason === 'winter' ? '❄️ Winter' : '☀️ Summer'} Dinacharya
          </ScheduleTitle>
