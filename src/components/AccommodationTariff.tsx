        ...
        <table className="min-w-full border border-gray-400 text-center text-sm">
          <thead className="bg-gray-300">
            <tr>
              ...
              <th className="border border-gray-400 px-2 py-2">Accommodations</th>
              <th className="border border-gray-400 px-2 py-2">Max Occupancy</th>
              {/* <th className="border border-gray-400 px-2 py-2">Accom. Count</th>
              <th className="border border-gray-400 px-2 py-2">Max Head Count</th>
              <th className="border border-gray-400 px-2 py-2">Unit Max</th> */}
              <th className="border border-gray-400 px-2 py-2">1st Guest</th>
              <th className="border border-gray-400 px-2 py-2">2nd Guest</th>
              <th className="border border-gray-400 px-2 py-2">3rd Guest</th>
              <th className="border border-gray-400 px-2 py-2">4th Guest</th>
              <th className="border border-gray-400 px-2 py-2">Servant</th>
          ...
          <tbody>
            {data.map((row) => (
              <tr key={row.sl} className="hover:bg-gray-100">
                <td className="border border-gray-400 px-2 py-2">{row.sl}</td>
                <td className="border border-gray-400 px-2 py-2 text-left">{row.name}</td>
                <td className="border border-gray-400 px-2 py-2">{row.maxOcc}</td>
                {/* <td className="border border-gray-400 px-2 py-2">{row.accomCount}</td>
                <td className="border border-gray-400 px-2 py-2">{row.maxHead}</td>
                <td className="border border-gray-400 px-2 py-2">{row.unitMax}</td> */}
                <td className="border border-gray-400 px-2 py-2">{row.guest1}</td>
                <td className="border border-gray-400 px-2 py-2">{row.guest2}</td>
                <td className="border border-gray-400 px-2 py-2">{row.guest3}</td>
                <td className="border border-gray-400 px-2 py-2">{row.guest4}</td>
                <td className="border border-gray-400 px-2 py-2">{row.servant}</td>
                <td className="border border-gray-400 px-2 py-2 font-semibold">{row.total}</td>
              </tr>
            ))}
          </tbody>
        </table>
